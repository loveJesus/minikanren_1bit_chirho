...
% Domain type naming (for consistency across papers)
\newcommand{\bitvecchirho}{BitVec64Chirho}
\newcommand{\hierchirho}{Hierarchical4kChirho}
\newcommand{\hierlargechirho}{Hierarchical256kChirho}

% Measured performance values (from rust benchmarks, Jan 2026)
\newcommand{\bitvectimechirho}{420 ps}
\newcommand{\hiertimechirho}{39 ns}
\newcommand{\hierlargetimechirho}{2.5 $\mu$s}
\newcommand{\hierlargeopsechirho}{400K ops/sec}
