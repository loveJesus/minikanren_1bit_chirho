...
\newcommand{\bitvec}{BitVec64Chirho}
\newcommand{\hier}{Hierarchical4kChirho}
\newcommand{\hierlarge}{Hierarchical256kChirho}

% Measured performance values (from rust benchmarks, Jan 2026)
\newcommand{\bitvectime}{420 ps}
\newcommand{\hiertime}{39 ns}
\newcommand{\hierlargetime}{2.5 $\mu$s}
\newcommand{\hierlargeops}{400K ops/sec}
