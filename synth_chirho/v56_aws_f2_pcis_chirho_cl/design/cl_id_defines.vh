...
// - V5.3: 0xF053, V5.4: 0xF054, V5.5: 0xF055, V5.6: 0xF056
`define CL_SH_ID0       32'hF056_1D0F

// CL_SH_ID1
// - PCIe Subsystem/Subsystem Vendor ID Values
//    31:16: PCIe Subsystem ID (0xF056 = matching our device ID)
//    15: 0: PCIe Subsystem Vendor ID (0x1D51)
`define CL_SH_ID1       32'h1D51_F056
