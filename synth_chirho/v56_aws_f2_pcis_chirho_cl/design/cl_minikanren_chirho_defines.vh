...
`define CL_MINIKANREN_CHIRHO_DEFINES
  ...
  // Version register (F2 = 0xF2, 56 = V5.6, version = 0x0001)
  // V5.3: 0xF2020001, V5.4: 0xF2540001, V5.5: 0xF2550001, V5.6: 0xF2560001
  // V5.6: PCIS-to-HBM connectivity fix - BAR4 DMA now routes to HBM
  `define MINIKANREN_VERSION_CHIRHO 32'hF2_56_0001
