...
# Launch AWS F2 HDK Build V5.6 with PCIS-to-HBM Fix ☧
# ============================================================================
#
...
# Divine header
echo "============================================"
echo "miniKanren F2 HBM Build V5.6 Starting ☧"
...
// ============================================================================
// For God so loved the world - John 3:16
// PCIe Device IDs for miniKanren F2 Custom Logic V5.6
// ============================================================================
// Vendor ID: 0x1D0F (Amazon)
// Device ID: 0xF056 (V5.6 with PCIS fix)
// Subsystem Vendor: 0x1D51
// Subsystem Device: 0xF056
// ============================================================================

`define CL_SH_ID0 32'hF056_1D0F   // {device_id, vendor_id}
`define CL_SH_ID1 32'h1D51_F056   // {subsystem_device_id, subsystem_vendor_id}
EOF
fi
...
if [ -f "$CL_DIR/build/checkpoints/to_aws/*.Developer_CL.tar" ]; then
    ...
    echo "     --name miniKanren-V56-PCIS-chirho \\"
