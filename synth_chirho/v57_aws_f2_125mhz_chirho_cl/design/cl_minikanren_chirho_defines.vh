...
`define CL_MINIKANREN_CHIRHO_DEFINES
  ...
  // Version register (F2 = 0xF2, 57 = V5.7, version = 0x0001)
  // V5.3: 0xF2020001, V5.4: 0xF2540001, V5.5: 0xF2550001, V5.6: 0xF2560001, V5.7: 0xF2570001
  // V5.7: 125MHz clock (8ns period) to fix -2.5ns timing violation at 250MHz
  `define MINIKANREN_VERSION_CHIRHO 32'hF2_57_0001
  ...
  // ========================================================================
  // V5.6 PCIS/Arbiter Debug Registers
  // ========================================================================
  `define REG_ARBITER_CHIRHO        8'hE0  // {30'b0, grant_fsm, grant_pcis}
  `define REG_PCIS_ADDR_LO_CHIRHO   8'hE4  // pcis_hbm_awaddr[31:0]
  `define REG_PCIS_ADDR_HI_CHIRHO   8'hE8  // pcis_hbm_awaddr[33:32]
  `define REG_PCIS_ACTIVE_CHIRHO    8'hEC  // {31'b0, pcis_active}
  `define REG_PCIS_WRITE_CNT_CHIRHO 8'hF0  // PCIS write count
  `define REG_PCIS_READ_CNT_CHIRHO  8'hF4  // PCIS read count
